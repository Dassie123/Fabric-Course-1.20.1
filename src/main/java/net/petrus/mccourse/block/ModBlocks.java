...
import net.petrus.mccourse.block.custom.*;
import net.petrus.mccourse.sound.ModSounds;
import net.petrus.mccourse.util.ModWoodTypes;
import net.petrus.mccourse.world.tree.DriftwoodSaplingGenerator;
...
public class ModBlocks {
    ...
    public static final Block COLORED_LEAVES = registerBlockWithoutBlockItem("colored_leaves",
