package net.petrus.mccourse.block.entity.renderer;

import net.petrus.mccourse.block.custom.GemEmpoweringStationBlock;
import net.petrus.mccourse.block.entity.GemEmpoweringStationBlockEntity;
